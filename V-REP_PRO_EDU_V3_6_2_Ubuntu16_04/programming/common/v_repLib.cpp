...
ptrSimRunSimulatorEx simRunSimulatorEx=0;
...
ptrSimSetDoubleSignal simSetDoubleSignal=0;
ptrSimGetDoubleSignal simGetDoubleSignal=0;
ptrSimClearDoubleSignal simClearDoubleSignal=0;
...
ptrSimApplyTexture simApplyTexture=0;
ptrSimSetJointDependency simSetJointDependency=0;
ptrSimSetStringNamedParam simSetStringNamedParam=0;
ptrSimGetStringNamedParam simGetStringNamedParam=0;


// Following courtesy of Stephen James:
ptrSimExtLaunchUIThread simExtLaunchUIThread=0;
ptrSimExtCanInitSimThread simExtCanInitSimThread=0;
ptrSimExtSimThreadInit simExtSimThreadInit=0;
ptrSimExtSimThreadDestroy simExtSimThreadDestroy=0;
ptrSimExtPostExitRequest simExtPostExitRequest=0;
ptrSimExtGetExitRequest simExtGetExitRequest=0;
ptrSimExtStep simExtStep=0;
ptrSimExtCallScriptFunction simExtCallScriptFunction=0;
...
int getVrepProcAddresses(LIBRARY lib)
{
    ...
    if (simSetDoubleSignal==0)
    {
        printf("%s simSetDoubleSignal\n",couldNotFind);
        return 0;
    }
    if (simGetDoubleSignal==0)
    {
        printf("%s simGetDoubleSignal\n",couldNotFind);
        return 0;
    }
    if (simClearDoubleSignal==0)
    {
    ...
    if (simApplyTexture==0)
    {
        printf("%s simApplyTexture\n",couldNotFind);
        return 0;
    }
    if (simSetJointDependency==0)
    {
        printf("%s simSetJointDependency\n",couldNotFind);
        return 0;
    }
    if (simSetStringNamedParam==0)
    {
        printf("%s simSetStringNamedParam\n",couldNotFind);
        return 0;
    }
    if (simGetStringNamedParam==0)
    {
    ...
    // Following courtesy of Stephen James:
    if (simExtLaunchUIThread==0)
    {
        printf("%s simExtLaunchUIThread\n",couldNotFind);
        return 0;
    }
    if (simExtCanInitSimThread==0)
    {
        printf("%s simExtCanInitSimThread\n",couldNotFind);
        return 0;
    }
    if (simExtSimThreadInit==0)
    {
        printf("%s simExtSimThreadInit\n",couldNotFind);
        return 0;
    }
    if (simExtSimThreadDestroy==0)
    {
        printf("%s simExtSimThreadDestroy\n",couldNotFind);
        return 0;
    }
    if (simExtPostExitRequest==0)
    {
        printf("%s simExtPostExitRequest\n",couldNotFind);
        return 0;
    }
    if (simExtGetExitRequest==0)
    {
